...
const GlobalHeader = (props) => {
    ...
    return (
      <UncontrolledDropdown>
        <DropdownToggle className="bootNavColor" nav>
          <FontAwesomeIcon icon={faQuestionCircle} className="moreIcon" />
          Help
        </DropdownToggle>
        <DropdownMenu right>
          ...
          <DropdownItem
            onClick={launch("https://www.openingtree.com/old", "OldVersion")}
          >
  ...
  const getMoreDropDown = () => {
    return (
      <UncontrolledDropdown>
        <DropdownToggle className="bootNavColor" nav>
          <FontAwesomeIcon icon={faCaretDown} className="moreIcon" />
          More
        </DropdownToggle>
        <DropdownMenu right>
          ...
          <DropdownItem
            onClick={launch("https://www.lichess4545.com/", "lichess4545")}
          >
            <span>Lichess4545</span>
          </DropdownItem>
          <DropdownItem
            onClick={launch("https://www.chess.com", "chessDotCom")}
          >
            <span>Chess.com</span>
          </DropdownItem>
          <DropdownItem
  ...
  const data = {
    rows: [
      ...
      {
        title:
          "Do I need to keep reloading games everytime I want to analyze the same player? OR What is a .tree file?",
      ...
      {
        title:
          "Is there a way to filter games by time control, choose only recent games etc.?",
  ...
  const getFAQModal = () => {
    return (
      <Modal isOpen={isFAQOpen} toggle={toggleFAQModal}>
        <ModalHeader toggle={toggleFAQModal}>
        ...
        <ModalFooter>
          <Button color="secondary" onClick={toggleFAQModal}>
            Done
          </Button>
        </ModalFooter>
      </Modal>
    ...
    return (
      <Modal isOpen={modal} toggle={toggleModal}>
        ...
        <ListGroup className="acknowledgement">
          ...
          <ListGroupItem
            tag="a"
            href="https://github.com/niklasf/eco"
            target="_blank"
            action
          >
            Eco
          ...
          <ListGroupItem
            tag="a"
            href="https://github.com/jimmywarting/StreamSaver.js"
            target="_blank"
            action
          >
            StreamSaver.js
          ...
          <ListGroupItem
            tag="a"
            href="https://github.com/kevinludwig/pgn-parser"
            target="_blank"
            action
          >
            PGN Parser
          ...
          <ListGroupItem
            tag="a"
            href="https://www.npmjs.com/package/material-ui-dropzone"
            target="_blank"
            action
          >
            Dropzone
          ...
          <ListGroupItem
            tag="a"
            href="https://www.twitch.tv/imrosen"
            target="_blank"
            action
          >
            IM Eric Rosen
        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav className={`mr-auto`} navbar>
            <NavItem>
              ...
              >
                <span>"It's so powerful" - IM Eric Rosen</span>
                <span className="smallText">[Video]</span>
              </NavLink>
            </NavItem>
          </Nav>
          ...
          <Nav className="" navbar>
            <NavItem>
              <NavLink
                className="navLinkButton"
                onClick={launch("https://youtu.be/9w7GdGuJoyk", "tutorial")}
              >
          ...
          <Nav className="" navbar>
            <NavItem>
              <NavLink
                className="navLinkButton"
                onClick={launch(Constants.OPENING_TREE_DISCORD, "discord")}
              >
