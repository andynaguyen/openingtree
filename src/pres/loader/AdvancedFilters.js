...
export default class AdvancedFilters extends React.Component {
    ...
    return (
      <div>
        {this.subSectionComponent(
          "Mode",
          getRatedLabel(this.props.advancedFilters.rated),
          this.props.toggleRated
        )}
        {this.subSectionComponent(
          "Time control",
          getTimeControlLabel(this.props.site, this.props.advancedFilters),
          this.setCurrentlyOpenAdvancedFilter("timeControl").bind(this),
          <Collapse
            isOpen={this.state.currentlyOpenAdvancedFilter === "timeControl"}
          >
        ...
        {this.subSectionComponent(
          "From Date",
          getFromDateLabel(
            this.props.advancedFilters[Constants.FILTER_NAME_FROM_DATE]
          ),
          this.setCurrentlyOpenAdvancedFilter("fromDate").bind(this),
          <Collapse
            isOpen={this.state.currentlyOpenAdvancedFilter === "fromDate"}
          >
        ...
        {this.subSectionComponent(
          "To Date",
          getToDateLabel(
            this.props.advancedFilters[Constants.FILTER_NAME_TO_DATE]
          ),
          this.setCurrentlyOpenAdvancedFilter("toDate").bind(this),
          <Collapse
            isOpen={this.state.currentlyOpenAdvancedFilter === "toDate"}
          >
        ...
        {this.subSectionComponent(
          ...
          getELORangeLabel(
            this.props.advancedFilters[Constants.FILTER_NAME_ELO_RANGE]
          ),
          this.setCurrentlyOpenAdvancedFilter("eloRange").bind(this),
          <Collapse
            isOpen={this.state.currentlyOpenAdvancedFilter === "eloRange"}
          >
        ...
        {this.subSectionComponent(
          "Opponent name",
          opponentNameLabel(
            this.props.advancedFilters[Constants.FILTER_NAME_OPPONENT]
          ),
          this.setCurrentlyOpenAdvancedFilter("opponent").bind(this),
          <Collapse
            isOpen={this.state.currentlyOpenAdvancedFilter === "opponent"}
          >
        ...
        {this.subSectionComponent(
          "Download limit",
          getDownloadLimitLabel(
            this.props.advancedFilters[Constants.FILTER_NAME_DOWNLOAD_LIMIT]
          ),
          this.setCurrentlyOpenAdvancedFilter("downloadLimit").bind(this),
          <Collapse
            isOpen={this.state.currentlyOpenAdvancedFilter === "downloadLimit"}
          >
    ...
    return (
      <Slider
        ...
        valueLabelFormat={(val) =>
          val >= Constants.MAX_DOWNLOAD_LIMIT ? "All" : val
        }
        step={100}
        min={0}
  ...
  getFromDateFilter() {
    return (
      <DatePicker
        ...
        selected={this.props.advancedFilters[Constants.FILTER_NAME_FROM_DATE]}
  ...
  getToDateFilter() {
    return (
      <DatePicker
        placeholderText="mm/dd/yyyy"
        selected={this.props.advancedFilters[Constants.FILTER_NAME_TO_DATE]}
  ...
  getOpponentNameFilter() {
    return (
      <TextField
        ...
        name="opponentName"
        id="opponentNameTextBox"
        margin="dense"
        onChange={this.props.handleOpponentNameChange}
        label={"Opponent Name"}
        variant="outlined"
        value={this.props.advancedFilters[Constants.FILTER_NAME_OPPONENT]}
      />
    );
  }
  ...
  getTimeControlFilters(site) {
    ...
    if (site === "lichess") {
      ...
      firstRow = [Constants.TIME_CONTROL_BULLET, Constants.TIME_CONTROL_BLITZ];
      lastRow = [Constants.TIME_CONTROL_RAPID, Constants.TIME_CONTROL_DAILY];
      colWidth = "6";
    }
    return (
      <FormControl>
        <FormGroup>
          <Container>
            ...
            {middleRow
              ? this.getTimeControlFilterRow(middleRow, colWidth, "middle")
              : null}
        ...
        {controls.map((control) => (
          <Col sm={firstColumnWidth} key={`ctrl${control}`}>
            <FormControlLabel
              ...
              control={
                <Checkbox
                  checked={this.props.advancedFilters[control]}
                  color="primary"
                  onChange={this.props.handleTimeControlChange}
                  name={control}
                />
              }
    ...
    return (
      <div className="pgnloadersection">
        ...
        <span className="smallText">
          [
          <span className="linkStyle" onClick={changeCallback}>
            change
          </span>
          ]
        </span>
