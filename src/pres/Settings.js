...
export default class SettingsView extends React.Component {
    ...
    return () => {
      ...
      switch (eventName) {
        case Constants.SETTING_NAME_ORIENTATION:
          newValue =
            this.props.settings[eventName] === Constants.PLAYER_COLOR_WHITE
  ...
  analyse() {
    window.open(
      `https://www.lichess.org/analysis/standard/${this.props.fen}`,
      "_blank"
    );
  }
          ...
          <Row>
            <Col xs="4">
              <Button
                ...
                onClick={this.toggle(Constants.SETTING_NAME_ORIENTATION)}
                color=""
              >
                <h3>
            ...
            <Col xs="4">
              <Button
                className="settingButton"
                onClick={this.toggle(Constants.SETTING_NAME_DARK_MODE)}
                color=""
              >
                <h3>
                  <FontAwesomeIcon
                    icon={this.props.settings.darkMode ? faLightbulb : faMoon}
                  />
                </h3>
                <span>
